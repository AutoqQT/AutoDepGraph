...
class Test_Graph(TestCase):
    ...
    def test_maintain_node_assume_unkown_is_good(self):
        self.test_graph.set_all_node_states("unknown")
    ...
    def test_set_function(self):
        ...
        self.assertEqual(
            self.test_graph.get_node_attribute("A", "description"), "explain node A"
        )

    def test_maintain_node_require_cal(self):
        self.test_graph.set_all_node_states("needs calibration")
        self.test_graph.maintain_node("C")
        self.assertEqual(self.test_graph.nodes()["C"]["state"], "good")
        self.assertEqual(self.test_graph.nodes()["B"]["state"], "good")
        self.assertEqual(self.test_graph.nodes()["D"]["state"], "needs calibration")
    ...
    def test_write_read_yaml(self):
        ...
        yaml.dump(self.test_graph, fn)
        read_testgraph = yaml.load(fn, Loader=yaml.Loader)
